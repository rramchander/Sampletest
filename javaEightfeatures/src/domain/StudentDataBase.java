...
public class StudentDataBase {
	...
	public static List<Student> getAllStudents(){
		...
		Student student2= new Student("Jenny",2, 3.8,"female",Arrays.asList("swimming","gymnastics","soccar"));
		Student student3= new Student("Emily",3, 4.0,"female",Arrays.asList("swimming","gymnastics","aerobics"));
		Student student4= new Student("Dave",3, 3.9,"male",Arrays.asList("swimming","gymnastics","soccar"));
		...
		List<Student> studentObj = Arrays.asList(student1,student2,student3,student4,student5,student6);
		return studentObj;
	}
